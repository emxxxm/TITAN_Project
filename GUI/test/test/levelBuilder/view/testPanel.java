...
public class testPanel extends TestCase {
	...
	public void testPreview1(){
		...
		m.getNumFrequency().setFre2(0.3);
		m.getNumFrequency().setFre3(0.2);
		m.getNumFrequency().setFre4(0.2);
		m.getNumFrequency().setFre5(0.1);
		m.getNumFrequency().setFre5(0.1);
		ArrayList<Position>  disableList = new ArrayList<Position>();
		ArrayList<Position> bucketList = new ArrayList<Position>();
		ArrayList<Position> sixList = new ArrayList<Position>();
		Position spos = new Position(5,1);
		Position bpos = new Position(2,1);
		Position pos = new Position(0,0);
		disableList.add(pos);
		bucketList.add(bpos);
		sixList.add(spos);
	...
	public void testPreview2(){
		...
		m.getNumFrequency().setFre5(0.0);
		ArrayList<Position>  disableList = new ArrayList<Position>();
		ArrayList<Position> bucketList = new ArrayList<Position>();
		ArrayList<Position> sixList = new ArrayList<Position>();
		Position spos = new Position(6,1);
		Position bpos = new Position(4,1);
